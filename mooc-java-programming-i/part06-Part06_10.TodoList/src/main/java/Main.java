...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        The final product will work in the following manner.
        ...
        - public void print() - prints the exercises. Each task has a number associated with it on the print statement
        ...
        that is used to start the text user interface. The text UI works with an eternal looping statement (while-true),
        and it must offer the following commands to the user:

        - The command stop stops the execution of the loop, after which the execution of the program advances
          out of the start method.
        - The command add asks the user for the next task to be added. Once the user enters this task,
          it should be added to the to-do list.
