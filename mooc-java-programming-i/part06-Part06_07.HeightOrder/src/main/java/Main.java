...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /*
        A Person class is included in the exercise template.
        A person has a name and a height. In this exercise, we'll implement a Room class,
        which can be used to add people and order them according to their height — taking a person
        out of the room always returns the shortest person.
        ...
        and it should have a parameterless constructor. In addition, add the following methods to the class:
        ...
        Add a public Person take() method to the Room class, which takes the shortest person in the room.
