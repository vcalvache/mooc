public class Summation {
    ...
    public static void main(String[] args) {
        ...
        NB: when an exercise describes a method that should return something,
        this means that the type of the return value must be declared in the method definition,
        and that the method contains a return command that returns the wanted data.
        The method itself will print nothing (i.e. will not use the command System.out.println) -
