...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Part 1: Gift-class
        Create a Gift class, where the objects instantiated from it represent different kinds of gifts.
        ...
        Create a Package class to which gifts can be added,
        and that keeps track of the total weight of the gifts in the package.
